...
open(my $GFFRepeatMasker, ">:encoding(UTF-8)", "../RepeatModeler.gff3");
...
sub funcaoMontaGFFHeader{
	...
	$HeaderLineFormatted .= ".";
	$HeaderLineFormatted .= "\t";
	$HeaderLineFormatted .= "Software=RepeatModeler;Length=" . (@allRecords[14] - @allRecords[12]) . "bps;Description=" . @allRecords[20] . "\n";
...
sub funcaoMontaFASTAHeader{
	...
	$HeaderLineFormatted .= "\t";
	$HeaderLineFormatted .= "Software=RepeatModeler;Superfamily=" . @allRecords[10] . ";Length=" . (@allRecords[14] - @allRecords[12]) . "bps;Description=" . @allRecords[20] . "\n";
