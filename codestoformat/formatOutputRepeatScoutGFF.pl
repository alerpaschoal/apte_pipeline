...
open(my $GFFRepeatScout, ">:encoding(UTF-8)", "RepeatScout.gff3");
...
sub funcaoMontaGFFHeader{
	...
	$HeaderLineFormatted .= ".";
	$HeaderLineFormatted .= "\t";
	$HeaderLineFormatted .= "Software=RepeatScout;Length=" . (@allRecords[14] - @allRecords[12]) . "bps;Description=" . @allRecords[20] . "\n";
...
sub funcaoMontaFASTAHeader{
	...
	$HeaderLineFormatted .= "\t";
	$HeaderLineFormatted .= "Software=RepeatScout;Superfamily=" . @allRecords[10] . ";Length=" . (@allRecords[14] - @allRecords[12]) . "bps;Description=" . @allRecords[20] . "\n";
...
print $GFFRepeatScout $GFFOutPut;
#print $FASTARepeatScout $FASTAOutPut;

close($GFFRepeatScout);
